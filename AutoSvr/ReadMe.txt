========================================================================
    ACTIVE TEMPLATE LIBRARY : AutoSvr Project Overview
========================================================================

AppWizard has created this AutoSvr project for you to use as the starting point for
...
AutoSvr.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (AutoSvr.h)
        GUID definitions                                (AutoSvr_i.c)
        A type library                                  (AutoSvr.tlb)
        Marshaling code                                 (AutoSvr_p.c and dlldata.c)

AutoSvr.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in AutoSvr.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named AutoSvr.pch and a precompiled types file named StdAfx.obj.
...
AutoSvrps.vcxproj
	...
	dlldata.c, AutoSvr_i.c and AutoSvr_p.c which are required
	to build the proxy/stub DLL.

AutoSvrps.vcxproj.filters
